...
public interface CheckinSvcApi {
	...
	public static final String VIDEO_TITLE_SEARCH_PATH =  "/search/findByName";
	
	// The path to search videos by title
	public static final String VIDEO_DURATION_SEARCH_PATH = "/search/findByDurationLessThan";
